...
if templog:
    try:
        timestamp,temperatura,__ = lector_templog(directorio)
...
for k in range(len(fnames_m)):
    ...
    if Analisis_de_Fourier == 1: 
        _, fig2_fourier, _,delta_phi_0,f_0,amp_0,fase_0, espectro_f_amp_fase_m,espectro_ref = fourier_señales_5(t_m_3,Resta_m_3,v_r_m_3,
        ...
        output_spec = os.path.join(output_dir_espectros, fnames_m[k][:-4] + '_espectro.txt') # Especificar la ruta completa del archivo de salida
